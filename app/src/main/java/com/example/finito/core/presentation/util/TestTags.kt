...
object TestTags {
    ...
    const val SORTING_CHIP = "SORTING_CHIP"

    const val MENU_OPTION = "MENU_OPTION"
    const val MENU_BUTTON = "MENU_BUTTON"

    const val CARD_MENU = "CARD_MENU"
    const val CARD_MENU_BUTTON = "CARD_MENU_BUTTON"
    const val TOGGLE_LAYOUT_BUTTON = "TOGGLE_LAYOUT_BUTTON"

    const val BOARDS_GRID = "BOARDS_GRID"
    const val BOARDS_LIST = "BOARDS_LIST"
    const val BOARD_CARD = "BOARD_CARD"
