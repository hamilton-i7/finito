...
sealed class TomorrowEvent {
    ...
    data class ShowTaskDateTimeFullDialog(val task: TaskWithSubtasks?) : TomorrowEvent()
    ...
    data class ChangeTaskPriorityConfirm(val task: TaskWithSubtasks) : TomorrowEvent()

    data class ChangeBoard(val board: SimpleBoard, val task: TaskWithSubtasks? = null) : TomorrowEvent()
